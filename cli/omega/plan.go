...
{"smap", "recon", "go install github.com/s0md3v/smap/cmd/smap@latest", true, false, false, false, "", "", ""},
{"rustscan", "recon", "cargo install rustscan", false, true, false, false, "", "", ""},
{"dnstake", "recon", "go install github.com/pwnesia/dnstake/cmd/dnstake@latest", true, false, false, false, "", "", ""},
// ── Tier 2 New Tools ────────────────────────────────────────────────────────
{"ctfr", "recon", "pip3 install ctfr --break-system-packages", false, false, true, false, "", "", ""},
{"mapcidr", "recon", "go install github.com/projectdiscovery/mapcidr/cmd/mapcidr@latest", true, false, false, false, "", "", ""},
{"sslscan", "recon", "sudo apt install -y sslscan", false, false, false, false, "", "", ""},
{"uro", "recon", "pip3 install uro --break-system-packages", false, false, true, false, "", "", ""},
{"misconfig-mapper", "recon", "go install github.com/intigriti/misconfig-mapper/cmd/misconfig-mapper@latest", true, false, false, false, "", "", ""},
{"second-order", "recon", "go install github.com/mhmdiaa/second-order@latest", true, false, false, false, "", "", ""},
// ── Tier 3 New Tools ────────────────────────────────────────────────────────
{"crosslinked", "recon", "pip3 install crosslinked --break-system-packages", false, false, true, false, "", "", ""},
{"enum4linux-ng", "recon", "pip3 install enum4linux-ng --break-system-packages", false, false, true, false, "", "", ""},
